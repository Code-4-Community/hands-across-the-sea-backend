...
public class Emailer {
  ...
  /**
   * Sends a basic email with given text subject and body to each of the given recipients. Will
   * filter out any malformed email address passed before sending email.
   *
