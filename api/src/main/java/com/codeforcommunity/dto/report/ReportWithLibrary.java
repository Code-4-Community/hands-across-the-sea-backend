...
public class ReportWithLibrary extends ReportGeneric {
  ...
  private Integer schoolReportId;
  ...
  public ReportWithLibrary(Integer id, Integer userId, Integer schoolId, Integer numberOfChildren, Integer numberOfBooks, Integer mostRecentShipmentYear, Integer schoolReportId, Boolean isSharedSpace, Boolean hasInvitingSpace, String assignedPersonRole, String assignedPersonTitle, String apprenticeshipProgram, Boolean trainsAndMentorsApprentices, Boolean hasCheckInTimetables, Boolean hasBookCheckoutSystem, Integer numberOfStudentLibrarians, String reasonNoStudentLibrarians, Boolean hasSufficientTraining, String teacherSupport, String parentSupport) {
    super(id, userId, schoolId, numberOfChildren, numberOfBooks, mostRecentShipmentYear);
  ...
  public Integer getSchoolReportId() {
    return schoolReportId;
  }

  public void setSchoolReportId(Integer schoolReportId) {
    this.schoolReportId = schoolReportId;
  }
